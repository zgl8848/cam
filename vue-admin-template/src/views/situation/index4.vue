		...
		<div style="width: 100%;">
			<div style="" class="flex al-c top">
				...
				<div style="width:18.5%;margin-right: 20px;">
					<div class="k mb-20" style="width:100%;height: 270px;">
				...
				<div class="k" style="width:23% ;height: 560px;" v-show="isschool==0">
			...
			<div style="width: 100%;" class="flex al-c">
				...
				<div class="k " style="width: 79%;height:270px">
					<img src="../../../static/img/k3.png" alt="">
					<div class="bottom">
						<div class="aq-detail flex jc-c sj" style="width:29.7%;height: 240px;flex-flow: row wrap;">
							<div style="width: 100%;">
								...
								<div class="de-con jc-a flex mb-20">
									<div style="font-size: 14px;color: #fff;width: 11%;">
										实到
									</div>
									<div style="width: 26.5%;">
										<div style="background-color: rgba(255,255,255,0.5);width:100%;height: 20px;">
											<div style="height: 100%;background-color:#0cd0d2;width: 60%;"></div>
										</div>
										<div style="color: #0cd0d2;margin-top: 5px;">{{atnd.teacherAttendance.actual}}人</div>
									</div>
									<div style="width: 26.5%;">
										<div style="background-color: rgba(255,255,255,0.5);width: 100%;height: 20px;">
											<div style="height: 100%;background-color:#17de87;width: 70%;"></div>
										</div>
										<div style="color: #17de87;margin-top: 5px;">{{atnd.studentAttendance.actual}}人</div>
									</div>
								</div>
								<div class="de-con jc-a flex mb-20">
									<div style="font-size: 14px;color: #fff;width: 11%;">
									...
									<div style="width: 26.5%;">
										...
										<div style="color: #0cd0d2;margin-top: 5px;">{{atnd.teacherAttendance.leave}}人</div>
									</div>
									<div style="width: 26.5%;">
										<div style="background-color: rgba(255,255,255,0.5);width: 100%;height: 20px;">
											<div style="height: 100%;background-color:#17de87;width: 70%;"></div>
										</div>
										<div style="color: #17de87;margin-top: 5px;">{{atnd.studentAttendance.leave}}人</div>
									</div>
								</div>
								<div class="de-con jc-a flex">
									...
									<div style="width: 26.5%;">
										...
										<div style="color: #0cd0d2;margin-top: 5px;">{{atnd.teacherAttendance.absence}}人</div>
									</div>
									<div style="width: 26.5%;">
										<div style="background-color: rgba(255,255,255,0.5);width: 100%;height: 20px;">
											<div style="height: 100%;background-color:#17de87;width: 70%;"></div>
										</div>
										<div style="color: #17de87;margin-top: 5px;">{{atnd.studentAttendance.absence}}人</div>
									</div>
								</div>
							</div>
...
<style scoped>
	...
	.hasschool{
		width: 55%;height:554px;margin-right: 20px;
	}
	.noschool{
