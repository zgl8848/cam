  ...
  <div class="app-container flex" id="app-main">
    ...
    <div style class="flex fl-wa ri">
      <div class="k kr2" style>
        ...
        <div class="charts" id="chartsxg" style="width: 90%;height:90%;"></div>
      </div>
      <div class="k kr" style>
        <img src="../../../static/img/k6.png" alt />
        <div class="k-title">总体情况</div>
        <div class="charts" id="chartsqk" style="width: 90%;height:90%;"></div>
        <div class="tl flex">
          <div class="half" style="width: 50%;">
            <!--<div class="text flex al-c" style="margin-bottom: 10px;">-->
              <!--<div-->
                <!--style="width: 12px;height: 12px;background-color:rgba(0,0,0,0);margin-right: calc(0.4vw);"-->
              <!--&gt;</div>检查校次：-->
              <!--<span class="val">{{overall.inspect}}</span>-->
            <!--</div>-->
            <div class="text flex al-c" style="margin-bottom: 10px;">
              <div
                style="width: 12px;height: 12px;background-color:rgba(0,0,0,0);margin-right: calc(0.4vw);"
              ></div>整改个数：
              <span class="val">{{overall.question}}</span>
            </div>
            <div class="text flex al-c">
              <div
                style="width: 12px;height: 12px;background-color:rgba(0,0,0,0);margin-right: calc(0.4vw);"
              ></div>整改率：
              <span class="val">{{overall.rate}}</span>
            </div>
          </div>
          <div class="half" style="width: 50%;">
            <div class="text flex al-c" style="margin-bottom: 10px;">
              <div
                style="width: 12px;height: 12px;background-color:rgba(0,0,0,0);margin-right: calc(0.4vw);"
              ></div>隐患个数：
              <span class="val">{{overall.hiddenDanger}}</span>
            </div>
            <div class="text flex al-c" style="opacity: 0">
              <div
                style="width: 12px;height: 12px;background-color:rgba(0,0,0,0);margin-right: calc(0.4vw);"
              ></div>整改率：
              <span class="val">{{overall.rate}}%</span>
      ...
      <div class="k kr" style>
        ...
        <div class="charts" id="chartslx" style="width: 90%;height:90%;">
          <div style="width: 100%;height: 100%;" v-show="false">
            <div
              style="displayflex;width:calc(9.3vw);height:calc(7.8vw) ;margin: 0 auto;margin-top: 80px;align-items: center;justify-content: center;"
            >
              <img
                src="../../../static/img/nodeta.png"
                alt
        ...
        <div class="tl flex" style>
          <div class="half" style="width: 50%;">
            <div class="text flex al-c" style="margin-bottom: 10px;" v-if="classify.data.length>0">
              <div
                style="width: 12px;height: 12px;background-color:#16bcf8;margin-right: calc(0.4vw);"
              ></div>
            ...
            <div class="text flex al-c" v-if="classify.data.length>2">
              <div
                style="width: 12px;height: 12px;background-color:#15c7ac;margin-right: calc(0.4vw);"
              ></div>
            ...
            <div class="text flex al-c" v-if="classify.data.length>4">
              <div
                style="width: 12px;height: 12px;background-color:#f23737;margin-right: calc(0.4vw);"
              ></div>
          ...
          <div class="half" style="width: 50%;">
            <div class="text flex al-c" style="margin-bottom: 10px;" v-if="classify.data.length>1">
              <div
                style="width: 12px;height: 12px;background-color:#ffa245;margin-right: calc(0.4vw);"
              ></div>
            ...
            <div class="text flex al-c" v-if="classify.data.length>3">
              <div
                style="width: 12px;height: 12px;background-color:#9b3aff;margin-right: calc(0.4vw);"
              ></div>
...
<script>
import { getdt, overall, classify, getmap, trend_chart } from "@/api/survey";
import {
  center,
  getdatelist,
  debounce,
  ...
  mounted() {
    ...
    getmap(that.sp_sel[that.sp_sel.length - 1].time).then(response => {
      ...
      for (var i in jia.records) {
        ...
        if (parseInt(jia.records[i].number) > max) {
          console.log(jia.records[i].number);
          max = jia.records[i].number;
        }
      }
            ...
            for (var i = 0; i < that.getmap.array.length; i++) {
              if (params.name == that.getmap.array[i].area) {
                toolTiphtml =
                  ...
                  "<br>学校总数:" +
                  that.getmap.array[i].schoolnum +
                  "<br>检查总次数:" +
                  that.getmap.array[i].number;
              }
            }
            return toolTiphtml;
          }
