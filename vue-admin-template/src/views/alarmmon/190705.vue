				...
				<div class="tl flex">
					...
					<div class="half" style="width: 50%;">
						<div class="text flex al-c" style="margin-bottom: 10px;" v-if="classify.data.length>1">
							<div style="width: 12px;height: 12px;background-color:#f58080;margin-right: calc(0.4vw);"></div>{{classify.data[1].name}}：<span
				...
				<div class="tl flex">
					<div class="half" style="width: 50%;">
						<div class="text flex al-c" style="margin-bottom: 10px;" v-if="source.data.length>0">
							<div style="width: 12px;height: 12px;background-color:#e83e3e;margin-right: calc(0.4vw);"></div>{{source.data[0].name}}：<span
			...
			setOptionsfb() {
				this.chartfb.setOption({
					...
					series: [{
						...
						hoverAnimation: true,
						color: ["#e83e3e", "#f58080", "#ffdd40", "#85d7fe", "#37ddcd", "#ef922e"],
