<template>
	<div class="app-container flex" id="app-main">
		<div style="" class="lt">
			<div class="dt jg" style="width:100%;height:540px;">
			...
			<div class="k" style="width: 100%;height:270px;position: relative;">
		...
		<div style="" class="flex fl-wa ri">
			...
			<div class="k kr" style="margin-bottom: 0px;">
				...
				<div class="charts" id="chartsjc" style="width: 90%;height:90%;">
					<div v-show="true" style="displayflex;width:calc(9.3vw);height:calc(7.8vw) ;margin: 0 auto;margin-top: 80px;align-items: center;justify-content: center;">
