  ...
  <div class="app-container flex" id="app-main">
    ...
    <div style class="flex fl-wa ri">
      <div class="k kr jg" style>
        ...
        <div class="charts" id="chartszg" style="width: 90%;height:90%;"></div>
        <div class="tl flex">
          <div class="half" style="width: 50%;">
            <div class="text flex al-c">
              总隐患：
              <span class="val">{{overall.total}}</span>
            </div>
          </div>
          <div class="half" style="width: 50%;">
            <div class="text flex al-c jg" style>
              <!-- <div style="width: 12px;height: 12px;background-color:#ffdd40;margin-right: calc(0.4vw);"></div> -->
              处理中：
              <span class="val">{{overall.processing}}</span>
            </div>
            <div class="text flex al-c">
              <!-- <div style="width: 12px;height: 12px;background-color:#2adeff;margin-right: calc(0.4vw);"></div> -->
              已处理：
              <span class="val">{{overall.solved}}</span>
            </div>
          </div>
        </div>
      </div>
      <div class="k kr" style="margin-bottom: 10px;">
        ...
        <div class="charts" id="chartsfb" style="width: 90%;height:90%;"></div>

        <!--<div class="tl new2 flex">-->
          <!--<div class="half" style="width: 50%;">-->
            <!--<div class="text flex al-c" style="margin-bottom: 10px;" v-if="classify.data.length>0">-->
              <!--<div-->
                <!--style="width: 12px;height: 12px;background-color:#ed5151;margin-right: calc(0.4vw);"-->
              <!--&gt;</div>-->
              <!--&lt;!&ndash;{{classify.data[0].name}}：&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="val">{{classify.data[0].value}}</span>&ndash;&gt;-->
              <!--后勤管理：-->
            ...
            <!--<div class="text flex al-c" v-if="classify.data.length>2">-->
              ...
              <!--&gt;</div>-->
              <!--&lt;!&ndash;{{classify.data[2].name}}：&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="val">{{classify.data[2].value}}</span>&ndash;&gt;-->
            <!--</div>-->
            <!--<div class="text flex al-c" v-if="classify.data.length>4">-->
              ...
              <!--&gt;</div>-->
              <!--&lt;!&ndash;{{classify.data[4].name}}：&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="val">{{classify.data[4].value}}</span>&ndash;&gt;-->
            <!--</div>-->
          <!--</div>-->
          <!--<div class="half" style="width: 50%;">-->
            <!--<div class="text flex al-c" style="margin-bottom: 10px;" v-if="classify.data.length>1">-->
              ...
              <!--&lt;!&ndash;{{classify.data[1].name}}：&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="val">{{classify.data[1].value}}</span>&ndash;&gt;-->
            <!--</div>-->
            <!--<div class="text flex al-c" v-if="classify.data.length>3">-->
              ...
              <!--&gt;</div>-->
              <!--&lt;!&ndash;{{classify.data[3].name}}：&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="val">{{classify.data[3].value}}</span>&ndash;&gt;-->
            <!--</div>-->
            <!--<div class="text flex al-c" v-if="classify.data.length>5">-->
              ...
              <!--&gt;</div>-->
              <!--&lt;!&ndash;{{classify.data[5].name}}：&ndash;&gt;-->
              <!--&lt;!&ndash;<span class="val">{{classify.data[5].value}}</span>&ndash;&gt;-->
            <!--</div>-->
          <!--</div>-->
        <!--</div>-->

        <!--<div class="tl new flex">-->
          <!--<div class="half" style="width: 50%;">-->
            <!--<div class="text flex al-c" style="margin-bottom: 10px;" v-if="classify.data.length>0">-->
              <!--<div-->
                <!--style="width: 12px;height: 12px;background-color:#ed5151;margin-right: calc(0.4vw);"-->
      ...
      <div class="k kr" style="margin-bottom: 0px;">
        ...
        <div class="charts" id="chartsly" style="width: 90%;height:90%;"></div>
        <div class="tl flex">
          <div class="half" style="width: 50%;">
            <div class="text flex al-c" style="margin-bottom: 10px;" v-if="source.data.length>0">
              <div
                style="width: 12px;height: 12px;background-color:#e83e3e;margin-right: calc(0.4vw);"
              ></div>
              {{source.data[0].name}}：
              <span class="val">{{source.data[0].value}}</span>
            </div>
            <div class="text flex al-c" v-if="source.data.length>2">
              <div
                style="width: 12px;height: 12px;background-color:#19c79c;margin-right: calc(0.4vw);"
              ></div>
              {{source.data[2].name}}：
              <span class="val">{{source.data[2].value}}</span>
            </div>
            <div class="text flex al-c" v-if="source.data.length>4">
              <div
                style="width: 12px;height: 12px;background-color:#f3c420;margin-right: calc(0.4vw);"
              ></div>
              {{source.data[4].name}}：
              <span class="val">{{source.data[4].value}}</span>
            </div>
          </div>
          <div class="half" style="width: 50%;">
            <div class="text flex al-c" style="margin-bottom: 10px;" v-if="source.data.length>1">
              <div
                style="width: 12px;height: 12px;background-color:#ff8124;margin-right: calc(0.4vw);"
              ></div>
              {{source.data[1].name}}：
              <span class="val">{{source.data[1].value}}</span>
            </div>
            <div class="text flex al-c" v-if="source.data.length>3">
              <div
                style="width: 12px;height: 12px;background-color:#fa2e2e;margin-right: calc(0.4vw);"
              ></div>
              {{source.data[3].name}}：
              <span class="val">{{source.data[3].value}}</span>
            </div>
            <div class="text flex al-c" v-if="source.data.length>5">
              <div
                style="width: 12px;height: 12px;background-color:#a751ff;margin-right: calc(0.4vw);"
              ></div>
              {{source.data[5].name}}：
              <span class="val">{{source.data[5].value}}</span>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    ...
    source().then(response => {
	  let series = [];
	  let colorC=['#e83e3e','#ff8124','#19c79c','#fa2e2e','#f3c420'];
  ...
  methods: {
            ...
            for (var i = 0; i < that.getmap.array.length; i++) {
              if (params.name == that.getmap.array[i].area) {
                toolTiphtml =
                  ...
                  "<br>隐患总数:" +
                  that.getmap.array[i].total +
                  "<br>严重隐患:" +
                  that.getmap.array[i].serious;
              }
            }
            return toolTiphtml;
          }
    ...
    //       let data = {
    //         name: this.source.data[i].name,
    //         value: this.source.data[i].value
    //       };
    //       datas.push(data);
    //     }
    //   }
